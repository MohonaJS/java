...
ResultSet rs=st.executeQuery("select * from studentm inner join studentrr where studentm.rollnumber=studentrr.rollnumber and studentm.rollnumber='"+rollnumber+"'");
