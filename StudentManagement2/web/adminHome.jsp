                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="addresult.jsp" method="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="enggphysics">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="enggmathematics">
                                    </div>
                                </div>
  ...
  <div class="tbl-content">
    <table cellpadding="0" cellspacing="0" border="0">
      <tbody>
            ...
            Statement s=DBConnection.getCon().createStatement();
            ResultSet r=s.executeQuery("select * from smanagement");
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      <tbody>
        <%@page import="studentmanagement2.util.DBConnection" %>
            ...
            Statement s1=DBConnection.getCon().createStatement();
            ResultSet r1=s1.executeQuery("select * from viewresult");
