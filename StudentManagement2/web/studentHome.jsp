...
<% 
    ...
    ResultSet rs=st.executeQuery("select * from smanagement inner join result where smanagement.rollnumber=viewresult.rollnumber and smanagement.rollnumber="+rollNumber+"");
    if(rs.next()){
