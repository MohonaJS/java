  ...
  <div class="tbl-content">
    <table cellpadding="0" cellspacing="0" border="0">
      <tbody>
          ...
          <%
          Statement ps=DBConnection.getCon().createStatement();
          ResultSet rs=ps.executeQuery("select * from studentmanagement");
          while(rs.next()){
            %>   
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      <tbody>
         ...
         <%@page import="studentmanagement.util.DBConnection" %>
          <%@page import="java.sql.*" %>
          <%
          Statement ps1=DBConnection.getCon().createStatement();
          ResultSet rs1=ps1.executeQuery("select * from studentresult");
          while(rs1.next()){
            %>   
